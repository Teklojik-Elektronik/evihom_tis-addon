...
class ApplianceChannelsCrudController extends CrudController
{
    ...
    protected $channel_types = [
        ...
        'ac' => 'messages.ac',
        'floor_heating' => 'messages.floor_heating',
        'virtual_input' => 'messages.virtual_input',
        'virtual_output' => 'messages.virtual_output'
    ];
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings(__('messages.appliance_channel'), __('messages.appliance_channels'));
        $devices = Device::all();
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field("appliance_id")->type("select2")->label(__('messages.appliance'))->attribute("appliance_name")->model("App\Models\Appliance");
    }
